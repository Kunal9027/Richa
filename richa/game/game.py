...
def main():
    ...
    SHOOT_SOUND = pygame.mixer.Sound(os.path.join("Gun+Silencer.mp3"))
    HIT_SOUND = pygame.mixer.Sound(os.path.join("Grenade+1.mp3"))
    GAME_OVER = pygame.mixer.Sound(os.path.join("mixkit-arcade-retro-game-over-213.wav"))
    ...
    ENEMY_SHIP_IMAGE = pygame.image.load(os.path.join("spaceship_yellow.png"))
    ...
    RED_PLAYER = pygame.image.load(os.path.join("spaceship_red.png")) # load players image
